    ...
    <div className="containerTerminos">
      <div>
        ...
        <p className="parrafos">
          Esta página web es propiedad y está operado por app alergic. Estos
          Términos establecen los términos y condiciones bajo los cuales puedes
          usar nuestra página web y nuestros servicios. Esta página web ofrece a
          los visitantes app alergic. Al acceder o usar la página web, aceptas
      ...
      <div>
        ...
        <p className="parrafos">
          ...
          necesario para el uso de alguno de nuestros servicios. App alergic no
          asume la responsabilidad en caso de que entregue dicha clave a
          terceros.
        </p>

        <p className="parrafos">
          Todas las transacciones que se lleven a cabo por medio de este sitio
          web, están sujetas a un proceso de confirmación y verificación, el
          cual podría incluir la validación de la forma de pago, validación de
        ...
        <p className="parrafos">
          Los precios de los servicios ofrecidos en esta web son válidos
          solamente en las suscripciones realizadas en este sitio web.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="parrafos">
          App alergic a través de su sitio web concede una licencia para que los
          usuarios utilicen los servicios que son vendidos en este sitio web de
          acuerdo a los Términos y Condiciones que se describen en este
          documento.
        </p>
      </div>
      <Link to="/inicio" className="confiAlergia-superior__link">

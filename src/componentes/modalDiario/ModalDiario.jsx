...
const ModalDiario = ({product, productStatus, setShowModalDiary}) => {
    ...
    const modalMsg = {
        ...
        unknown: 'Vas a añadir al diario un producto del que no tenemos suficiente información',
            ...
            {modalContent === 'a'
                ...
                : modalContent === 'b' 
                    ? <div className='modal-box'>
                        ...
                        <textarea placeholder='escribe aquí tu comentario' onInput={handleSubmit(storeComment)} id="comment" {...register("comment")}></textarea>

                        <div className='modal-box-btns'>
                            <button 
                                onClick={()=>{addToDiary(product) ; setModalContent('c')}}

...
const ModalFavs = ({ product, productStatus, setShowModalFavs }) => {
  ...
  const modalMsg = {
    ...
    unknown:
      "¿Seguro que quieres añadir este producto a favoritos? No tenemos suficiente información como para garantizar que no contenga alérgenos",
  ...
  return (
    <div className="modal">
      <div
        className={"modal-box " + (modalContent === "b" && "modal-box--hidden")}
      >
      ...
      <div
        className={"modal-box " + (modalContent === "a" && "modal-box--hidden")}
      >
